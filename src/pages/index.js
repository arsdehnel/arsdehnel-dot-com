					...
					<div className="site-section-card">
						...
						<div className="site-section-content">
							...
							<p>
								...
								other roles exist to support this or really could be expressed
								as just a part of this.
							</p>
						</div>
					</div>
					<div className="site-section-card">
						...
						<div className="site-section-content">
							<h3>Nerd</h3>
							<p>
								Starting as a teenager in my parents&apos; basement breaking
								their 386 SX regularly I&apos;ve been a lifelong technology
								tinkerer.
							</p>
						</div>
					</div>
