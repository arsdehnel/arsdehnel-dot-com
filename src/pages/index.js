		...
		<>
			<div className="home-columns">
				...
				<section>
					...
					<div className="site-section-cards">
						<div className="site-section-card">
							<img className='home-card-image' src="public/posts/camping-car-storage/initial-prototype.jpg" alt="alt text here" />
							<h3>Father</h3>
				...
				<section className='posts'>
					...
					<a className="more-link" href="/posts">Read All Posts</a>
				</section>
